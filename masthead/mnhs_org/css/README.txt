...
To use these stylesheets, rename the files and mnhs_org with the name of your theme.
...
mnhs_org-alpha-default-narrow.css  
...
mnhs_org-alpha-default-normal.css
...
mnhs_org-alpha-default-wide.css
